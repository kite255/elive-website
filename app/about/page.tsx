        ...
        <div className="relative min-h-[520px] w-full overflow-hidden bg-[var(--color-elive-primary)] md:min-h-[600px]">
          ...
          <div className="relative mx-auto flex min-h-[520px] max-w-7xl items-center px-5 py-10 md:min-h-[600px] md:px-8 lg:px-10">
            ...
            >
              ...
              <motion.p
                variants={fadeUp}
                className="mt-8 max-w-[650px] text-base leading-8 text-white/90 md:text-lg"
              >
              ...
              <motion.div variants={fadeUp} className="mt-8 flex flex-wrap gap-4">
                ...
                <Link
                  href="/services"
                  className="inline-flex items-center justify-center rounded-xl border border-white/25 bg-white/8 px-7 py-4 text-base font-medium !text-white backdrop-blur-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-white/45 hover:bg-white/12"
                >
                  Explore Services
                </Link>
              </motion.div>
